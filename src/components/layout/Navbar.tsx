...
export default function Navbar() {
  ...
  const navItems = [{ href: "/", label: t("home") }, { href: "/learn", label: t("learn") }, { href: "/decode", label: t("decode") }, { href: "/quiz", label: t("quiz") }, { href: "/time-attack", label: t("timeAttack") }, { href: "/real-weather", label: t("realWeather") }, { href: "/missions", label: t("missions") }, { href: "/progress", label: t("progress") }];
