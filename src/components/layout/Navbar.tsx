...
export default function Navbar() {
  ...
  const navItems = [{ href: "/", label: t("home") }, { href: "/onboarding", label: t("onboarding") }, { href: "/learn", label: t("learn") }, { href: "/decode", label: t("decode") }, { href: "/quiz", label: t("quiz") }, { href: "/time-attack", label: t("timeAttack") }, { href: "/exam", label: t("exam") }, { href: "/real-weather", label: t("realWeather") }, { href: "/briefing-lab", label: t("briefingLab") }, { href: "/missions", label: t("missions") }, { href: "/leaderboard", label: t("leaderboard") }, { href: "/progress", label: t("progress") }];
